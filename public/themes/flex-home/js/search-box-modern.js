(function ($) {
    ...
    function updateSearchBoxActive() {
        var box = $('.search-box-modern');
        if ($('.sbm-dropdown.open').length) {
            box.addClass('sbm-active');
        } else {
            box.removeClass('sbm-active');
        }
    }
